...
# lxfTODO(dzc): Once these functions have been factored out of Bazel's
...
# lxfTODO(csigg): Only call once instead of from here, tensorrt_configure.bzl,
...
def _create_local_cuda_repository(repository_ctx):
    ...
    # toolchain.
    # lxfTODO: when bazel stops adding '-B/usr/bin' by default, remove this
