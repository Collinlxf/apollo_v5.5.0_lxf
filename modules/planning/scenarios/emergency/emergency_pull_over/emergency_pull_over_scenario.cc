...
/**
 * @file
 * emergency_pull_over_scenario.cc / .h / _test.cc:
 * emergency_pull_over_scenario.cc: 实现了紧急停车场景的主要逻辑。
 * emergency_pull_over_scenario.h: 紧急停车场景的类声明和接口。
 * emergency_pull_over_scenario_test.cc: 对紧急停车场景进行单元测试的代码。
 **/
